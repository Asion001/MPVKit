...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Libmpv",
            url: "https://github.com/Asion001/MPVKit/releases/download/1.0.0-swiftfin.4/Libmpv.xcframework.zip",
            checksum: "bc9bc1d2324835db6d8feb2f765aad25d44fe0a2d8712b47f371d331995e3a28"
        ),
